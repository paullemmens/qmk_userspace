 ...
 */
    [_QWERTY] = LAYOUT_wrapper(
      ...
      _______, _________________QWERTY_L3_________________, MODQWER, OS_LCMD, _______, _______, _________________QWERTY_R3_________________, _______,
 ...
 *                        `----------------------------------'  `----------------------------------'
 */
    [_OS_MODS] = LAYOUT_wrapper(
      _______, _________________OS_MODS_L1________________,                                     _________________OS_MODS_R1________________, _______,
      _______, _________________OS_MODS_L2________________,                                     _________________OS_MODS_R2________________, _______,
      _______, _________________OS_MODS_L3________________, OS__CMD, _______, _______, _______, _________________OS_MODS_R3________________, _______,
                                 MODQWER, _______, OS__CMD, _______, _______, OS__CMD, _______, _______, _______, _______
    ),
#endif //CALLUM_ONESHOT
/*
 ...
 */
    [_ADJUST] = LAYOUT_wrapper(
      ...
      RGB_TOG, _________________ADJUST_L3_________________, RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SW, _________________ADJUST_R3_________________, _______,
                                 KC_MUTE, _______, _______, KC_NUM,  KC_SCRL, KC_INS,  MACOS_L,  DEFAU_L,  _______, _______
    ),
// /*
//  * Layer template
//  *
